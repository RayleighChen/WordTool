...
public class WordUtil {
	...
	public WordUtil(boolean visible) {
		...
		if (documents == null)//word.m_pDispatch==0
	...
	public String getParagraphFromAnotherDoc(String anotherDocPath,
			int paragraphIndex) {
...
//					.println(Dispatch.get(paragraph, "OutlineLevel").getInt());
	...
	public void setTableStyle() {
        ...
        for (int i = 0; i < count; i++) { 
        		...
        		setFont(false, false, false, "0,0,0,0", "10.5", "宋体", "3");
        } 
	}
	...
	public void setPicTitle(){
		...
		Dispatch netAlignment = Dispatch.get(selection, "ParagraphFormat")
				.toDispatch();// 段落格式
		Dispatch.put(netAlignment, "Alignment", "3"); // (1:置中 2:靠右 3:靠左)
	...
	public void setTitleStyle(String style) {
		...
		setFont(false, false, false, "0,0,0,0", "14", "宋体", "3");
